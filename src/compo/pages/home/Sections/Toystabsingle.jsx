...
const Toystabsingle = ({ toysData }) => {
    let { _id, picture, toyName, sellerName, sellerEmail, price, rating, availableQuantity, detaillDescription, catagory } = toysData
    return (
        <div className="flex flex-col items-center border-2 p-1 gap-3 rounded-md">
            ...
            <div className="capitalize w-full h-full flex flex-col justify-between gap-3 px-2" >
                <div className="bg-gray-100 w-full py-3 px-2 min-h-[200px]">
                ...
                <div className="self-cente w-full flex justify-center" data-aos='zoom-in' >
